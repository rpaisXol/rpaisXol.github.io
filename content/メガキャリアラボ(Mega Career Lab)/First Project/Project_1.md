...
* **한국 (KOSIS 국가데이터처):** 
  * 고령인구비율 (DT_1YL20631)[한국의 고령화 인구비율](https://docs.opencv.org/4.x/d4/dc6/tutorial_py_template_matching.html)
  * 시도별 장기요양기관 현황 [한국의 시도별 장기요양기관 현황](https://docs.opencv.org/4.x/d4/dc6/tutorial_py_template_matching.html)
  * 인구 천 명당 의료기관 병상수 [한국의 인구 천 명당 의료기관 병상수](https://docs.opencv.org/4.x/d4/dc6/tutorial_py_template_matching.html)
* **일본 (e-Stat 정부통계포털):** 
  * 인구추계 (각 년 10월 1일 기준) [일본의 인구추계](https://docs.opencv.org/4.x/d4/dc6/tutorial_py_template_matching.html)
  * 사회·인구통계체계의 의료 및 복지 분야 지표 [일본의 사회·인구통계체계의 의료 및 복지 분야](https://docs.opencv.org/4.x/d4/dc6/tutorial_py_template_matching.html)
...
3. 끊김 없는 시계열 데이터 확보 (데이터 소스 변경)
   - 5년 주기의 '국세조사' 대신 매년 갱신되는 '인구추계(2015~2024)' 데이터를 활용하여 연도별 빈틈없는 총인구 및 65세 이상 인구 통계를 구축
...
POP_ESTIMATE_SERIES = [
    ...
    ("0003448237", "2020년국세조사기준"),  # 2020~2024
]
...
* 5. 인구 데이터 전용 특수 수집
```python
# 2015~2024년 총인구 및 65세 이상 인구를 추출하는 전용 모듈
